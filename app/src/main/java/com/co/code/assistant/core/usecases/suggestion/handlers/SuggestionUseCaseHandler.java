...
public class SuggestionUseCaseHandler {
    ...
    public Observable<List<ISuggestionDomain>> get(Map<String, List<String>> params) {
        ...
        params.put("prompt", List.of(
                "You are a issue detector for java code. do not use backticks triple backticks (```).  Please remove all instances of triple backticks (```) . 1. If the input of the user is not a java code, please say that you do not have feedback for code different to Java. 2. The user input will use HTML tags. 3. Use this template to identify issues related to SonarQube, Checkstyle, and PMD : " +
                        "<body><h2>Sonarqube Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_HIGHLIGHTED_WITH_CSS_COLORS_AND_USE_HTML_FORMATTED_AND_IGNORE_INDENTATION_RULE</li> </ul> " +
                        "<h2>Checkstyle Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_HIGHLIGHTED_WITH_CSS_COLORS_AND_USE_HTML_FORMATTED_AND_IGNORE_INDENTATION_RULE</li> </ul> " +
                        "<h2>PMD Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_HIGHLIGHTED_WITH_CSS_COLORS_AND_USE_HTML_FORMATTED_AND_IGNORE_INDENTATION_RULE</li> </ul> " +
                        "<h2>Performance & Security Issues</h2> <ul> <li>EXPLANATION_OF_CODE_PERFORMANCE_SECURITY_ISSUE_WITH_CSS_COLORS_AND_USE_HTML_FORMATTED</li> </ul>  " +
                        "<h2>Cyclomatic Complexity</h2> <ul> <li>RATE_BETWEEN_1_TO_100_OF_CODE_CYCLOMATIC_COMPLEXITY</li></ul> <ul>EXPLANATION_OF_RATE_BETWEEN_1_TO_100_CYCLOMATIC_COMPLEXITY</ul> </body>" +
                        "<h2>Cognitive Complexity </h2> <ul> <li>RATE_BETWEEN_1_TO_100_OF_CODE_COGNITIVE_COMPLEXITY</li></ul> <ul>EXPLANATION_OF_RATE_BETWEEN_1_TO_100_CODE_COGNITIVE_COMPLEXITY</ul> </body>" +
                        ...
                        "<h2>Code suggestion </h2> <ul> <li><code>FULL_JAVA_CODE_SUGGESTION_FIXING_ISSUES_HIGHLIGHTED_WITH_CSS_COLORS_AND_USE_HTML_FORMATTED(Use HTML break lines and indentation with double space)</code></li> </ul>. TAKE_INTO_ACCOUNT: HIGHLIGHTED should use red color for errors and blue color for new code."
        ));
        ...
        return Observable.zip(clientOpenIA.getInformation(params),
                                ...
                                clientCopilot.getInformation(params),
                                    (openIA, geminis, copilot) -> {
                                        params.put("prompt", List.of("The user will provide input from the Source 1, Source 2, and Source 3. Do not use backtick triple backticks (```). Please remove all instances of triple backticks (```) . Create a executive summary joining the information divided by 3 sections. One for PMD issues, Second for Checkstyle issues and third one with SonarQube issues. Use this template to return the answer in HTML format:<body> <h1>Code Analysis Results</h1> <h2>Sonarqube Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_AND_USE_HTML_FORMAT</li> </ul> <h2>Checkstyle Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_AND_USE_HTML_FORMAT</li> </ul> <h2>PMD Issues</h2> <ul> <li>EXPLANATION_WITH_CODE_ISSUE_AND_USE_HTML_FORMAT</li> </ul> <h2>Quality of code</h2> <ul> <li>Cyclomatic Complexity: RATE_BETWEEN_1_TO_100_CYCLOMATIC_COMPLEXITY</li></ul> <ul> <li>Cognitive Complexity: RATE_BETWEEN_1_TO_100_COGNITIVE_COMPLEXITY</li></ul> <ul><li>Quality: RATE_BETWEEN_1_TO_100_QUALITY_OF_CODE</li> </ul> <h2>Code suggestion </h2> <ul> <li><code>FULL_JAVA_CODE_SUGGESTION_FIXING_ISSUES_HIGHLIGHTED_WITH_CSS_COLORS_AND_USE_HTML(Use <br> instead of \n and indentation with double space)</code></li> </ul></body>. do not use backticks triple backticks (```). Please remove all instances of triple backticks (```) ."));
